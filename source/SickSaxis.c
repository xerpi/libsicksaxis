 ...
 */
static uint8_t _ss_leds_rumble_payload[SS_LEDS_RUMBLE_LEN] =
{
	0x52, //0x52
	0x01,
...
//Functions
	...
	int ss_open(ss_instance_t *ss)
	{
		...
		memcpy ((void *)ss->leds_rumble, (void *)_ss_leds_rumble_payload, SS_LEDS_RUMBLE_LEN);
